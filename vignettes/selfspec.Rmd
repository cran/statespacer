...
To fit the dynamic Nelson-Siegel model using statespacer, we need to pass on a list containing the specification of the model. See the Details section of `StateSpaceFit()` for extensive details about the format of this list!
